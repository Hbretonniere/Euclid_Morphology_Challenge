...
imas=['ds_u_lsst.native.fits', 'ds_g_lsst.native.fits', 'ds_r_lsst.native.fits', 'ds_i_lsst.native.fits', 'ds_z_lsst.native.fits', 'ds_vis.fits', 'ds_y_nir.native.fits', 'ds_j_nir.native.fits', 'ds_h_nir.native.fits' ]
weis=[ 'ds_u_lsst.rms.native.fits', 'ds_g_lsst.rms.native.fits', 'ds_r_lsst.rms.native.fits', 'ds_i_lsst.rms.native.fits', 'ds_z_lsst.rms.native.fits', 'ds_vis.rms.fits', 'ds_y_nir.rms.native.fits', 'ds_j_nir.rms.native.fits', 'ds_h_nir.rms.native.fits' ]
...
r_b = FreeParameter(lambda o: o.get_radius()*0.5, Range(lambda v,o: (0.01*v,30*v), RangeType.EXPONENTIAL))
r_d = FreeParameter(lambda o: o.get_radius()*2, Range(lambda v,o: (0.01*v,30*v), RangeType.EXPONENTIAL))
### from ground truth 
